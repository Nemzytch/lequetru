                ...
                if self.datas["gameData"]["gameTime"] > 600:
                    if self.jungleDead == False:
                        ...
                        while self.attached== False:
                            ...
                            time.sleep(2)
                            self.lastAttachTarget = "Jungler"
                        if self.attached==True:
                            if jungleHP<85:
                                self.manacheckE()
                                print('Tried to heal jungle')
                    ...
                    if self.jungleDead == True:
                        if self.midDead == False:
                            ...
                            while self.attached== False:
                                ...
                                print('going to mid')
                                time.sleep(2)
                                self.lastAttachTarget = "Mid"
                            if self.attached == True:
                                if midHP<85:
                                    self.manacheckE()
                                    print('Tried to heal mid')
...
#lastR : failed or successfully limité à 2 par game
